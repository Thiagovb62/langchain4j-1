package com.thiago.lang4jtestt.Service;
...
//@AiService(wiringMode = AiServiceWiringMode.EXPLICIT, chatModel = "openAiChatModel") quando queremos usar varios modelos diferentes em uma mesma aplicação
@AiService
